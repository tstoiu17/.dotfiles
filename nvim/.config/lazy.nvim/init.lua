...
vim.g.mapleader = " "
nmap("<leader>`", "<C-6>", "alternate file")
nmap("<leader>L", ":Lazy<cr>")
nmap("<leader>h", ":nohl<cr>")
nmap("<leader>Y", ":%y+<cr>", "yank file to system clipboard")
nvmap("<leader>y", '"+y')
nvmap("<leader>p", '"+p')
nvmap("<leader>P", '"+P')
nmap("<leader>V", "ggVG")
nmap("<leader>=", "mzgg=G`z", "= all lines")

vim.g.maplocalleader = "\\"
nmap("<localleader>w", ":w<cr>")
nmap("<localleader>W", ":w !sudo tee %<cr>", "write as root")
nmap("<localleader>q", ":qa<cr>")
nmap("<localleader>Q", ":qa!<cr>")
nmap("<localleader>t", ":tabclose<cr>")

nmap("<Tab>", "za", "toggle fold")

-- i dont use <s> anyway, and its more convenient that pressing <C-w>
nmap("s", "<C-w>")
...
-- if lazypath doesn't exist, clone lazy.nvim repo
